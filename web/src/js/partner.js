...
var PartnerJoin = React.createClass({
    ...
    handleClickSubmit: function () {
        ...
        data.firstname = $join.find("input[name=firstname]").val();
        data.lastname = $join.find("input[name=lastname]").val();
        data.company = $join.find("input[name=company]").val();
        data.country = $join.find("select[name=country]").val();
        data.email = $join.find("input[name=email]").val();
        data.msg = $join.find("textarea[name=msg]").val();
        ...
        if(data.company == "" ) {
            console.info("This field is required");
            $join.find("input[name=company]").next().show();
        }
        if(data.email == "" || ( data.email != "" && !/.+@.+\.[a-zA-Z]{2,4}$/.test(data.email))){
                            ...
                            <div className="form-box-l">
                                ...
                                <div className="dd">
                                    <ul>
                                        ...
                                        <li>
                                            <div className="ipt">
                                                <s className="ico-company"></s><input type="text" required name="company" placeholder="Company Name"/>
                                                <div className="err-msg"><i></i><span>This field is required</span></div>
                                            </div>
                                        </li>
                                        <li>
